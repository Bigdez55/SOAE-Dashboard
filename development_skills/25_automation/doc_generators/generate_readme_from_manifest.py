...
def main():
    ...
    # README.generated
    sysdirs = sorted([d for d in os.listdir(ROOT) if d[:2].isdigit() and d[2]=="_"])
    ...
    readme.append(f"\n## Stats")
    for k in ("systems_count","schemas_count","templates_count","skills_count","adrs_count","twins_count","commands_count"):
