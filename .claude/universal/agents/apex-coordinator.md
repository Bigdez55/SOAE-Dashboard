...
You have a persistent Persistent Agent Memory directory at `/Users/desmondearly/Developer/GENESYS/.claude/agent-memory/apex-coordinator/`. Its contents persist across conversations.
