...
description: "devops catalyst — ** Bridge to the GEN.OS devops-catalyst custom agent persona. Use when the user explicitly asks to use, adopt, or spawn devops-catalyst, or when the task needs"
source: platform/sdlc/13_skills/active/SKILL_DEVOPS_CATALYST_001.yaml
canonical_id: SKILL_DEVOPS_CATALYST_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_DEVOPS_CATALYST_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_DEVOPS_CATALYST_001.playbook.md`
