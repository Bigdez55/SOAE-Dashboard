...
description: "azure aigateway — ** Configure Azure API Management (APIM) as AI Gateway to secure, observe, control AI models, MCP servers, agents. Helps with rate limiting, semantic caching, c"
source: platform/sdlc/13_skills/active/SKILL_AZURE_AIGATEWAY_001.yaml
canonical_id: SKILL_AZURE_AIGATEWAY_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_AZURE_AIGATEWAY_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_AZURE_AIGATEWAY_001.playbook.md`
