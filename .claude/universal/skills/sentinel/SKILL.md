---
name: sentinel
description: "IPOS Sentinel — Dashboard testing strategies: Jest unit tests for KPI calculators and contract compliance, React Testing Library for component interactions, Playwright E2E for"
source: platform/sdlc/13_skills/active/SKILL_IPOS_SENTINEL_001.yaml
canonical_id: SKILL_IPOS_SENTINEL_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_IPOS_SENTINEL_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_IPOS_SENTINEL_001.playbook.md`
