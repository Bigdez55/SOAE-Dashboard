---
name: gate-harness-process-isolation
description: "Gate Harness Process Isolation — Triggers: \"harness timeout\", \"retry storm\", \"test runner hang\", \"perl alarm\", \"bash timeout\", \"process leak\", \"orphan PID\", \"CI gate hanging\", \"macOS test runne"
source: platform/sdlc/13_skills/active/SKILL_GATE_HARNESS_PROCESS_ISOLATION_001.yaml
canonical_id: SKILL_GATE_HARNESS_PROCESS_ISOLATION_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_GATE_HARNESS_PROCESS_ISOLATION_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_GATE_HARNESS_PROCESS_ISOLATION_001.playbook.md`
