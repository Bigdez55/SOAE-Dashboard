---
name: microsoft-foundry-models-deploy-model-preset
description: "preset — ** Intelligently deploys Azure OpenAI models to optimal regions by analyzing capacity across all available regions. Automatically checks current region first an"
source: platform/sdlc/13_skills/active/SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_PRESET_001.yaml
canonical_id: SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_PRESET_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_PRESET_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_PRESET_001.playbook.md`
