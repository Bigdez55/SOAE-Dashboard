---
name: 36-frontend-backend-dataflow-connection-map
description: Frontend Backend Dataflow Connection Map — SKILL_FRONTEND_BACKEND_DATAFLOW_001
source: platform/sdlc/13_skills/active/SKILL_FRONTEND_BACKEND_DATAFLOW_001.yaml
canonical_id: SKILL_FRONTEND_BACKEND_DATAFLOW_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_FRONTEND_BACKEND_DATAFLOW_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_FRONTEND_BACKEND_DATAFLOW_001.playbook.md`
