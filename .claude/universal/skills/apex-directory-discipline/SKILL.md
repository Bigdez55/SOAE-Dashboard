---
name: apex-directory-discipline
description: "apex-directory-discipline — ** Governs all file and directory operations within the GENOSCOPY / Project Apex codebase. Use this skill BEFORE creating any file, directory, or document in an"
source: platform/sdlc/13_skills/active/SKILL_DIRECTORY_DISCIPLINE_001.yaml
canonical_id: SKILL_DIRECTORY_DISCIPLINE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_DIRECTORY_DISCIPLINE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_DIRECTORY_DISCIPLINE_001.playbook.md`
