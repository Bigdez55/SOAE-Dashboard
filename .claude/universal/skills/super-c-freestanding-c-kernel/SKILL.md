---
name: super-c-freestanding-c-kernel
description: "Freestanding C Kernel Development — 57 Core Skills — Build a bare-metal x86-64 kernel with zero libc dependency. Every kernel .c file begins with `#ifndef PAL_FREESTANDING` / `#define PAL_FREESTANDING` / `#endif`."
source: platform/sdlc/13_skills/active/SKILL_SUPER_C_FREESTANDING_C_KERNEL_001.yaml
canonical_id: SKILL_SUPER_C_FREESTANDING_C_KERNEL_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_SUPER_C_FREESTANDING_C_KERNEL_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_SUPER_C_FREESTANDING_C_KERNEL_001.playbook.md`
