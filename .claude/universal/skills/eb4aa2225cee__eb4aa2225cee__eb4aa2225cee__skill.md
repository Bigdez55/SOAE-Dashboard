---
name: fortress
description: Angular 17+ dashboard engineering with Codename FORTRESS. Covers NgRx state management, Angular Material components, RxJS reactive patterns, standalone components, signals, and zone-less change detection for high-performance KPI dashboards. Trigger on: "Angular dashboard", "NgRx", "Angular Material chart", "standalone component", "Angular signals", "FORTRESS".
---
