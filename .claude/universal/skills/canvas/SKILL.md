---
name: canvas
description: "canvas — ** Custom D3.js visualizations with Codename CANVAS. Low-level SVG and Canvas rendering, force-directed graphs, custom chart types unavailable in standard React"
source: platform/sdlc/13_skills/active/SKILL_CANVAS_001.yaml
canonical_id: SKILL_CANVAS_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_CANVAS_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_CANVAS_001.playbook.md`
