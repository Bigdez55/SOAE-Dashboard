---
name: the-architect
description: "the architect — ** Bridge to the GEN.OS the-architect custom agent persona. Use when the user explicitly asks to use, adopt, or spawn the-architect, or when the task needs this"
source: platform/sdlc/13_skills/active/SKILL_THE_ARCHITECT_001.yaml
canonical_id: SKILL_THE_ARCHITECT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_THE_ARCHITECT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_THE_ARCHITECT_001.playbook.md`
