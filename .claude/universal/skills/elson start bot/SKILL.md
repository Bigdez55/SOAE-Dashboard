---
name: elson start bot
description: "Start Autonomous Trading Bot — Start the autonomous trading bot. Use when the user says start the bot, enable auto-trading, start trading, or begin the trading loop."
source: platform/sdlc/13_skills/active/SKILL_ELSON_START_BOT_001.yaml
canonical_id: SKILL_ELSON_START_BOT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_START_BOT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_START_BOT_001.playbook.md`
