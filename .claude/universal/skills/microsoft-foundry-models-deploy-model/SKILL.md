---
name: microsoft-foundry-models-deploy-model
description: "deploy model — ** Unified Azure OpenAI model deployment skill with intelligent intent-based routing. Handles quick preset deployments, fully customized deployments (version/SK"
source: platform/sdlc/13_skills/active/SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_001.yaml
canonical_id: SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_001.playbook.md`
