...
description: "master orchestrator — ** Bridge to the GEN.OS master-orchestrator custom agent persona. Use when the user explicitly asks to use, adopt, or spawn master-orchestrator, or when the tas"
source: platform/sdlc/13_skills/active/SKILL_MASTER_ORCHESTRATOR_001.yaml
canonical_id: SKILL_MASTER_ORCHESTRATOR_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_MASTER_ORCHESTRATOR_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_MASTER_ORCHESTRATOR_001.playbook.md`
