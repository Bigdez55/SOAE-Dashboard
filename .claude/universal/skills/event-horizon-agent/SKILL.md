...
description: "event horizon agent — ** Bridge to the GEN.OS event-horizon-agent custom agent persona. Use when the user explicitly asks to use, adopt, or spawn event-horizon-agent, or when the tas"
source: platform/sdlc/13_skills/active/SKILL_EVENT_HORIZON_AGENT_001.yaml
canonical_id: SKILL_EVENT_HORIZON_AGENT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_EVENT_HORIZON_AGENT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_EVENT_HORIZON_AGENT_001.playbook.md`
