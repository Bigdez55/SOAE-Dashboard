---
name: AI automation
description: "AI-Native Tenant Automation — Use this skill to design AI assistants, agent workflows, tenant-aware automation, policy-safe AI operations, and optimization systems for multi-tenant platforms"
source: platform/sdlc/13_skills/active/SKILL_AI_NATIVE_TENANT_AUTOMATION_001.yaml
canonical_id: SKILL_AI_NATIVE_TENANT_AUTOMATION_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_AI_NATIVE_TENANT_AUTOMATION_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_AI_NATIVE_TENANT_AUTOMATION_001.playbook.md`
