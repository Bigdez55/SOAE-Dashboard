---
name: prestige-528
description: "prestige — ** Dashboard UI/UX design systems for paratransit dashboards: Transdev brand guidelines (red #DB0717), Fluent UI theming, shadcn/ui customization, color palette"
source: platform/sdlc/13_skills/active/SKILL_PRESTIGE_001.yaml
canonical_id: SKILL_PRESTIGE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_PRESTIGE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_PRESTIGE_001.playbook.md`
