---
name: table-master-537
description: "table-master — ** Advanced data table patterns: TanStack Table v8, Fluent UI DetailsList, AG Grid. Sorting, filtering, pagination, virtual scrolling for 100K+ rows, column res"
source: platform/sdlc/13_skills/active/SKILL_TABLE_MASTER_001.yaml
canonical_id: SKILL_TABLE_MASTER_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_TABLE_MASTER_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_TABLE_MASTER_001.playbook.md`
