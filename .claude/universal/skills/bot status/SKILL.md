---
name: bot status
description: "Autonomous Trading Bot Status — Check the autonomous trading bot status — running state, active strategies, recent signals, P&L, and circuit breaker state. Use when the user asks about the tra"
source: platform/sdlc/13_skills/active/SKILL_ELSON_BOT_STATUS_001.yaml
canonical_id: SKILL_ELSON_BOT_STATUS_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_BOT_STATUS_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_BOT_STATUS_001.playbook.md`
