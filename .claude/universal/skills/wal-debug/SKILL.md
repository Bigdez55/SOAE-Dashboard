---
name: wal-debug
description: "GEN.OS WAL Debug — XSTORE Crash Recovery Diagnosis — Diagnose and recover from XSTORE write-ahead log (WAL) failures in GEN.OS. - `xstore_open()` returns `XSTORE_ERR_CORRUPT` on boot after a crash - B+ tree key lo"
source: platform/sdlc/13_skills/active/SKILL_GENOS_WAL_DEBUG_001.yaml
canonical_id: SKILL_GENOS_WAL_DEBUG_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_GENOS_WAL_DEBUG_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_GENOS_WAL_DEBUG_001.playbook.md`
