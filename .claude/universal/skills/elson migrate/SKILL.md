---
name: elson migrate
description: "Database Migration Protocol — Run a database migration — generate Alembic migration, apply ALTER TABLE to Cloud SQL, and verify schema. Use when the user adds new model columns, changes sche"
source: platform/sdlc/13_skills/active/SKILL_ELSON_MIGRATE_001.yaml
canonical_id: SKILL_ELSON_MIGRATE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_MIGRATE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_MIGRATE_001.playbook.md`
