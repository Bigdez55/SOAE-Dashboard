...
description: "dashboard-scaffold — ** Universal dashboard scaffolding skill: generates complete project structures for React/Next.js, Vue/Nuxt, Angular, Svelte/SvelteKit, Python (Dash/Streamlit),"
source: platform/sdlc/13_skills/active/SKILL_DASHBOARD_SCAFFOLD_001.yaml
canonical_id: SKILL_DASHBOARD_SCAFFOLD_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_DASHBOARD_SCAFFOLD_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_DASHBOARD_SCAFFOLD_001.playbook.md`
