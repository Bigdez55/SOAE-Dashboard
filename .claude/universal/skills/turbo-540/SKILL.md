---
name: turbo-540
description: "turbo — ** Dashboard performance optimization: React.memo and useMemo for expensive KPI calculations, TanStack Virtual for large data tables, code splitting for chart l"
source: platform/sdlc/13_skills/active/SKILL_TURBO_001.yaml
canonical_id: SKILL_TURBO_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_TURBO_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_TURBO_001.playbook.md`
