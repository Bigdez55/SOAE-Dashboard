---
name: perf-profiler-525
description: "perf-profiler — ** Dashboard performance profiling and optimization: Core Web Vitals targets (LCP < 2.5s, CLS < 0.1, INP < 200ms), Lighthouse CI with performance budgets, bundl"
source: platform/sdlc/13_skills/active/SKILL_PERF_PROFILER_001.yaml
canonical_id: SKILL_PERF_PROFILER_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_PERF_PROFILER_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_PERF_PROFILER_001.playbook.md`
