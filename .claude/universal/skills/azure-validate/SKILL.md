---
name: azure-validate
description: "azure validate — ** Pre-deployment validation checkpoint. Run deep checks to ensure your application is ready for Azure deployment. Validates configuration, infrastructure, perm"
source: platform/sdlc/13_skills/active/SKILL_AZURE_VALIDATE_001.yaml
canonical_id: SKILL_AZURE_VALIDATE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_AZURE_VALIDATE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_AZURE_VALIDATE_001.playbook.md`
