...
description: "one-shot-execution-planning — ** Forces deep preflight planning before implementation on any milestone touching parser, sema, import, type system, linker, optimizer, boot, language surface,"
source: platform/sdlc/13_skills/active/SKILL_ONE_SHOT_EXECUTION_PLANNING_001.yaml
canonical_id: SKILL_ONE_SHOT_EXECUTION_PLANNING_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ONE_SHOT_EXECUTION_PLANNING_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ONE_SHOT_EXECUTION_PLANNING_001.playbook.md`
