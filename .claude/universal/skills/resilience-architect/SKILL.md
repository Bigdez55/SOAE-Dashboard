...
description: "resilience architect — ** Bridge to the GEN.OS resilience-architect custom agent persona. Use when the user explicitly asks to use, adopt, or spawn resilience-architect, or when the t"
source: platform/sdlc/13_skills/active/SKILL_RESILIENCE_ARCHITECT_001.yaml
canonical_id: SKILL_RESILIENCE_ARCHITECT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_RESILIENCE_ARCHITECT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_RESILIENCE_ARCHITECT_001.playbook.md`
