---
name: elson model health
description: "AI Model Health Check — elson-finance-14b — Check vLLM and elson-finance-14b model health — VM status, model loaded, inference latency, EFT agent configs, and fine-tuning readiness. Use when the user asks"
source: platform/sdlc/13_skills/active/SKILL_ELSON_MODEL_HEALTH_001.yaml
canonical_id: SKILL_ELSON_MODEL_HEALTH_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_MODEL_HEALTH_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_MODEL_HEALTH_001.playbook.md`
