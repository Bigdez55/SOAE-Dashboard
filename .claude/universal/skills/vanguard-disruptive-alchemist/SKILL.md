...
description: "vanguard disruptive alchemist — ** Bridge to the GEN.OS vanguard-disruptive-alchemist custom agent persona. Use when the user explicitly asks to use, adopt, or spawn vanguard-disruptive-alchem"
source: platform/sdlc/13_skills/active/SKILL_VANGUARD_DISRUPTIVE_ALCHEMIST_001.yaml
canonical_id: SKILL_VANGUARD_DISRUPTIVE_ALCHEMIST_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_VANGUARD_DISRUPTIVE_ALCHEMIST_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_VANGUARD_DISRUPTIVE_ALCHEMIST_001.playbook.md`
