---
name: knowledge depot
description: ATLAS Knowledge Depot Operating Model — Use this skill when ATLAS must function as a coding-agent knowledge depot instead of a static dashboard. The required outcome is an operational model where ever
source: platform/sdlc/13_skills/active/SKILL_KNOWLEDGE_DEPOT_001.yaml
canonical_id: SKILL_KNOWLEDGE_DEPOT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_KNOWLEDGE_DEPOT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_KNOWLEDGE_DEPOT_001.playbook.md`
