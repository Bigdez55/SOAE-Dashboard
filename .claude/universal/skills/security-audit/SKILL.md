---
name: security-audit
description: "GEN.OS Security Audit Checklist — Run with `guardian-sentinel` + `reliability-security-sentinel` agents. Classify findings: P0 (critical/blocking), P1 (fix before release), P2 (fix this sprint),"
source: platform/sdlc/13_skills/active/SKILL_GENOS_SECURITY_AUDIT_001.yaml
canonical_id: SKILL_GENOS_SECURITY_AUDIT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_GENOS_SECURITY_AUDIT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_GENOS_SECURITY_AUDIT_001.playbook.md`
