---
name: elson go build
description: "Go Microservices Build Verification — Build and verify all Go microservices — market-gateway, order-router, risk-engine. Use when the user asks to build Go services, check Go compilation, or verify"
source: platform/sdlc/13_skills/active/SKILL_ELSON_GO_BUILD_001.yaml
canonical_id: SKILL_ELSON_GO_BUILD_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_GO_BUILD_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_GO_BUILD_001.playbook.md`
