---
name: azure-kusto
description: "azure kusto — ** Query and analyze data in Azure Data Explorer (Kusto/ADX) using KQL for log analytics, telemetry, and time series analysis. USE FOR: KQL queries, Kusto datab"
source: platform/sdlc/13_skills/active/SKILL_AZURE_KUSTO_001.yaml
canonical_id: SKILL_AZURE_KUSTO_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_AZURE_KUSTO_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_AZURE_KUSTO_001.playbook.md`
