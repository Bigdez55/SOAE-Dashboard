---
name: ipos-alert-system
description: "IPOS Alert System — Threshold-based alert system: penalty warnings, KPI degradation alerts, anomaly detection (Z-score), multi-channel delivery (email, Slack, Teams, SMS, webhook),"
source: platform/sdlc/13_skills/active/SKILL_IPOS_ALERT_SYSTEM_001.yaml
canonical_id: SKILL_IPOS_ALERT_SYSTEM_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_IPOS_ALERT_SYSTEM_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_IPOS_ALERT_SYSTEM_001.playbook.md`
