...
description: "platform integrity auditor — ** Bridge to the GEN.OS platform-integrity-auditor custom agent persona. Use when the user explicitly asks to use, adopt, or spawn platform-integrity-auditor, o"
source: platform/sdlc/13_skills/active/SKILL_PLATFORM_INTEGRITY_AUDITOR_001.yaml
canonical_id: SKILL_PLATFORM_INTEGRITY_AUDITOR_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_PLATFORM_INTEGRITY_AUDITOR_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_PLATFORM_INTEGRITY_AUDITOR_001.playbook.md`
