...
description: "deploy-pipeline — ** CI/CD deployment pipelines for KPI dashboards: GitHub Actions workflows for GitHub Pages and SPFx (gulp bundle, package-solution, M365 CLI deploy), Vercel/Ne"
source: platform/sdlc/13_skills/active/SKILL_DEPLOY_PIPELINE_001.yaml
canonical_id: SKILL_DEPLOY_PIPELINE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_DEPLOY_PIPELINE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_DEPLOY_PIPELINE_001.playbook.md`
