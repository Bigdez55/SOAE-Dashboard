...
description: "agent-worktree-discipline — ** Pre-flight + post-flight discipline for ANY agent that creates a git worktree, writes files, and commits. Triggers on requests to \"create worktree\", \"git wor"
source: platform/sdlc/13_skills/active/SKILL_AGENT_WORKTREE_DISCIPLINE_001.yaml
canonical_id: SKILL_AGENT_WORKTREE_DISCIPLINE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_AGENT_WORKTREE_DISCIPLINE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_AGENT_WORKTREE_DISCIPLINE_001.playbook.md`
