---
name: elson vllm stop
description: "Stop vLLM VM — Cost Saver (~$1.50/hr) — Stop the vLLM VM to save costs after trading hours. Use when the user says stop the model, shutdown vLLM, save costs, or after market close."
source: platform/sdlc/13_skills/active/SKILL_ELSON_VLLM_STOP_001.yaml
canonical_id: SKILL_ELSON_VLLM_STOP_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_VLLM_STOP_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_VLLM_STOP_001.playbook.md`
