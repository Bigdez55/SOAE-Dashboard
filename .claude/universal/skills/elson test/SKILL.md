---
name: elson test
description: "Full Test Suite — Elson TB2 — Run the full Elson TB2 test suite — backend pytest, frontend TypeScript check, ESLint, and Go builds. Use when the user asks to run tests, check test status, or"
source: platform/sdlc/13_skills/active/SKILL_ELSON_TEST_001.yaml
canonical_id: SKILL_ELSON_TEST_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_TEST_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_TEST_001.playbook.md`
