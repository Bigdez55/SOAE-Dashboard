...
description: "intelligence lead v2 — ** Bridge to the GEN.OS intelligence-lead-v2 custom agent persona. Use when the user explicitly asks to use, adopt, or spawn intelligence-lead-v2, or when the t"
source: platform/sdlc/13_skills/active/SKILL_INTELLIGENCE_LEAD_V2_001.yaml
canonical_id: SKILL_INTELLIGENCE_LEAD_V2_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_INTELLIGENCE_LEAD_V2_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_INTELLIGENCE_LEAD_V2_001.playbook.md`
