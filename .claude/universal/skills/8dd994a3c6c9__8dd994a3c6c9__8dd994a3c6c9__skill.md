...
description: Use this skill when the user wants to design, scaffold, or code a SharePoint Framework (SPFx) dashboard. Triggers on requests for "SPFx web parts," "SharePoint dashboards," "PnPjs integration," "Fluent UI charts," "KPI_DailyData list," or "gulpfile build."
---
