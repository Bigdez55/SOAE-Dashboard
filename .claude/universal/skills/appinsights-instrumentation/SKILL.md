...
description: "appinsights instrumentation — ** Guidance for instrumenting webapps with Azure Application Insights. Provides telemetry patterns, SDK setup, and configuration references. USE FOR: how to ins"
source: platform/sdlc/13_skills/active/SKILL_APPINSIGHTS_INSTRUMENTATION_001.yaml
canonical_id: SKILL_APPINSIGHTS_INSTRUMENTATION_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_APPINSIGHTS_INSTRUMENTATION_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_APPINSIGHTS_INSTRUMENTATION_001.playbook.md`
