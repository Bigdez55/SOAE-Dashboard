---
name: sc-empirical-surface-probe
description: "sc-empirical-surface-probe — ** Empirical Surface Probe Mandate for SUPER C compiler work (`superc-v1/`). Invoke BEFORE designing any compiler patch, BEFORE asserting any claim about compil"
source: platform/sdlc/13_skills/active/SKILL_EMPIRICAL_SURFACE_PROBE_001.yaml
canonical_id: SKILL_EMPIRICAL_SURFACE_PROBE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_EMPIRICAL_SURFACE_PROBE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_EMPIRICAL_SURFACE_PROBE_001.playbook.md`
