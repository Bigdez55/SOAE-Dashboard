---
name: fortress
description: "fortress — ** Angular 17+ dashboard engineering with Codename FORTRESS. Covers NgRx state management, Angular Material components, RxJS reactive patterns, standalone compo"
source: platform/sdlc/13_skills/active/SKILL_FORTRESS_001.yaml
canonical_id: SKILL_FORTRESS_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_FORTRESS_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_FORTRESS_001.playbook.md`
