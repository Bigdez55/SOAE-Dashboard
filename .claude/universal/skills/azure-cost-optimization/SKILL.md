...
description: "azure cost optimization — ** Identify and quantify cost savings across Azure subscriptions by analyzing actual costs, utilization metrics, and generating actionable optimization recommen"
source: platform/sdlc/13_skills/active/SKILL_AZURE_COST_OPTIMIZATION_001.yaml
canonical_id: SKILL_AZURE_COST_OPTIMIZATION_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_AZURE_COST_OPTIMIZATION_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_AZURE_COST_OPTIMIZATION_001.playbook.md`
