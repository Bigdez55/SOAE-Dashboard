...
description: "system signal engine — ** Bridge to the GEN.OS system-signal-engine custom agent persona. Use when the user explicitly asks to use, adopt, or spawn system-signal-engine, or when the t"
source: platform/sdlc/13_skills/active/SKILL_SYSTEM_SIGNAL_ENGINE_001.yaml
canonical_id: SKILL_SYSTEM_SIGNAL_ENGINE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_SYSTEM_SIGNAL_ENGINE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_SYSTEM_SIGNAL_ENGINE_001.playbook.md`
