---
name: ATLAS MCP
description: "ATLAS MCP Server — Claude Code & Codex Integration — Use this skill when the user needs ATLAS capabilities exposed to Claude Code or"
source: platform/sdlc/13_skills/active/SKILL_MCP_001.yaml
canonical_id: SKILL_MCP_001
