...
description: "developer experience lead — ** Bridge to the GEN.OS developer-experience-lead custom agent persona. Use when the user explicitly asks to use, adopt, or spawn developer-experience-lead, or"
source: platform/sdlc/13_skills/active/SKILL_DEVELOPER_EXPERIENCE_LEAD_001.yaml
canonical_id: SKILL_DEVELOPER_EXPERIENCE_LEAD_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_DEVELOPER_EXPERIENCE_LEAD_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_DEVELOPER_EXPERIENCE_LEAD_001.playbook.md`
