---
name: xOrchestra
description: xOrchestra Future Sovereign Orchestration Adapter — Use this skill only when planning future GEN.OS integration or when the user explicitly asks to work on xOrchestra.  Do not invoke this skill as a current depen
source: platform/sdlc/13_skills/active/SKILL_XORCHESTRA_SOVEREIGN_ORCHESTRATION_001.yaml
canonical_id: SKILL_XORCHESTRA_SOVEREIGN_ORCHESTRATION_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_XORCHESTRA_SOVEREIGN_ORCHESTRATION_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_XORCHESTRA_SOVEREIGN_ORCHESTRATION_001.playbook.md`
