---
name: tenant model
description: "Tenant Model and Boundary Design — Use this skill to define what a tenant is, how tenants are structured, how boundaries are enforced, and how tenant lifecycle works."
source: platform/sdlc/13_skills/active/SKILL_TENANT_MODEL_BOUNDARY_DESIGN_001.yaml
canonical_id: SKILL_TENANT_MODEL_BOUNDARY_DESIGN_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_TENANT_MODEL_BOUNDARY_DESIGN_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_TENANT_MODEL_BOUNDARY_DESIGN_001.playbook.md`
