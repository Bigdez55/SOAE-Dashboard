---
name: elson signal audit
description: "Signal Gate Audit — Elson Trading Bot — Audit the autonomous trading signal gate — AI vs rule-based accuracy, confidence calibration, gate rejection rates, and strategy performance. Use when the user"
source: platform/sdlc/13_skills/active/SKILL_ELSON_SIGNAL_AUDIT_001.yaml
canonical_id: SKILL_ELSON_SIGNAL_AUDIT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_SIGNAL_AUDIT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_SIGNAL_AUDIT_001.playbook.md`
