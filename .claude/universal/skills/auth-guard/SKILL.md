---
name: auth-guard
description: "auth-guard — ** Authentication and authorization patterns for dashboards: JWT (access + refresh tokens), OAuth 2.0 PKCE, SAML SSO, SPFx context-based auth, PnPjs auth setup,"
source: platform/sdlc/13_skills/active/SKILL_AUTH_GUARD_001.yaml
canonical_id: SKILL_AUTH_GUARD_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_AUTH_GUARD_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_AUTH_GUARD_001.playbook.md`
