...
description: "verify-validate — ** Pre-commit verification and validation gate. Use this skill BEFORE every commit, after every file change, before closing any task or session, and BEFORE ever"
source: platform/sdlc/13_skills/active/SKILL_VERIFY_VALIDATE_001.yaml
canonical_id: SKILL_VERIFY_VALIDATE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_VERIFY_VALIDATE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_VERIFY_VALIDATE_001.playbook.md`
