...
You have a persistent Persistent Agent Memory directory at `/Users/desmondearly/Developer/GENESYS/.claude/agent-memory/event-horizon-agent/`. Its contents persist across conversations.
