---
name: elson perf report
description: "Trading Performance Report — Generate a trading performance report — P&L, win rate, Sharpe ratio, strategy breakdown, and progress toward $500/day goal. Use when the user asks about perform"
source: platform/sdlc/13_skills/active/SKILL_ELSON_PERF_REPORT_001.yaml
canonical_id: SKILL_ELSON_PERF_REPORT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_PERF_REPORT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_PERF_REPORT_001.playbook.md`
