---
name: azure-prepare
description: "azure prepare — ** Default entry point for Azure application development. Invoke this skill for ANY application work related to Azure: creating apps, building features, adding"
source: platform/sdlc/13_skills/active/SKILL_AZURE_PREPARE_001.yaml
canonical_id: SKILL_AZURE_PREPARE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_AZURE_PREPARE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_AZURE_PREPARE_001.playbook.md`
