---
name: build a multi-tenant platform
description: "Multi-Tenant Platform Architect — Use this skill when the user wants to design, build, audit, or extend a multi-tenant platform from top to bottom.  This skill is the master routing skill. It co"
source: platform/sdlc/13_skills/active/SKILL_MULTI_TENANT_PLATFORM_ARCHITECT_001.yaml
canonical_id: SKILL_MULTI_TENANT_PLATFORM_ARCHITECT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_MULTI_TENANT_PLATFORM_ARCHITECT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_MULTI_TENANT_PLATFORM_ARCHITECT_001.playbook.md`
