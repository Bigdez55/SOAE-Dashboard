---
name: pulse-530
description: "pulse — ** Real-time dashboard updates: WebSocket integration, Server-Sent Events (SSE), intelligent polling strategies, optimistic UI updates, stale data handling with"
source: platform/sdlc/13_skills/active/SKILL_PULSE_001.yaml
canonical_id: SKILL_PULSE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_PULSE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_PULSE_001.playbook.md`
