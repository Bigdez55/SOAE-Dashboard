---
name: elson plan feature
description: "Feature Planning Protocol — Plan a new feature — decompose requirements, identify impacted files, define API contracts, assign agents, and produce a phased implementation plan. Use when th"
source: platform/sdlc/13_skills/active/SKILL_ELSON_PLAN_FEATURE_001.yaml
canonical_id: SKILL_ELSON_PLAN_FEATURE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_PLAN_FEATURE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_PLAN_FEATURE_001.playbook.md`
