---
name: responsive-layout-531
description: "responsive-layout — ** Mobile-first responsive dashboard layouts: CSS Grid auto-fill/auto-fit patterns, container queries, Fluent UI Stack/StackItem for SPFx, mobile-first breakpoi"
source: platform/sdlc/13_skills/active/SKILL_RESPONSIVE_LAYOUT_001.yaml
canonical_id: SKILL_RESPONSIVE_LAYOUT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_RESPONSIVE_LAYOUT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_RESPONSIVE_LAYOUT_001.playbook.md`
