...
description: "entra app registration — ** Guides Microsoft Entra ID app registration, OAuth 2.0 authentication, and MSAL integration. USE FOR: create app registration, register Azure AD app, configur"
source: platform/sdlc/13_skills/active/SKILL_ENTRA_APP_REGISTRATION_001.yaml
canonical_id: SKILL_ENTRA_APP_REGISTRATION_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ENTRA_APP_REGISTRATION_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ENTRA_APP_REGISTRATION_001.playbook.md`
