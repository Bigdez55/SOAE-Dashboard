---
name: elson sprint init
description: "Sprint Initialization Protocol — Initialize a new development sprint — audit backlog, define goals, assign agent responsibilities, and create a phased execution plan. Use when the user says sta"
source: platform/sdlc/13_skills/active/SKILL_ELSON_SPRINT_INIT_001.yaml
canonical_id: SKILL_ELSON_SPRINT_INIT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_SPRINT_INIT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_SPRINT_INIT_001.playbook.md`
