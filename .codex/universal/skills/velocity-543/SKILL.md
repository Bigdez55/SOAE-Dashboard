---
name: velocity-543
description: "velocity — ** Svelte 5 and SvelteKit dashboard engineering with Codename VELOCITY. Covers Svelte Runes for reactive state, Svelte stores, SvelteKit layouts and routing, Ch"
source: platform/sdlc/13_skills/active/SKILL_VELOCITY_001.yaml
canonical_id: SKILL_VELOCITY_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_VELOCITY_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_VELOCITY_001.playbook.md`
