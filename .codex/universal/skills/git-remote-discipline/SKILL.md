---
name: git-remote-discipline
description: "git-remote-discipline — ** Pre-push remote verification discipline. MANDATORY before every git push. Triggers on: any git push command, \"push to remote\", \"push branch\", \"push tags\", \"-"
source: platform/sdlc/13_skills/active/SKILL_GIT_REMOTE_DISCIPLINE_001.yaml
canonical_id: SKILL_GIT_REMOTE_DISCIPLINE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_GIT_REMOTE_DISCIPLINE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_GIT_REMOTE_DISCIPLINE_001.playbook.md`
