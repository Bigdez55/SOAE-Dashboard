...
description: "GEN.OS Static Analysis — All 4 Tools — Run before every PR. Zero tolerance: 0 warnings, 0 violations, 0 CVEs. cppcheck --enable=warning,performance,portability \\ --error-exitcode=1 \\ --suppress=missi"
source: platform/sdlc/13_skills/active/SKILL_GENOS_STATIC_ANALYSIS_001.yaml
canonical_id: SKILL_GENOS_STATIC_ANALYSIS_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_GENOS_STATIC_ANALYSIS_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_GENOS_STATIC_ANALYSIS_001.playbook.md`
