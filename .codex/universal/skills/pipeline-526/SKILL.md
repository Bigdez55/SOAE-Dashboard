---
name: pipeline-526
description: "pipeline — ** Data pipeline design for paratransit dashboards: ETL patterns, SharePoint List schemas, Power Automate flows, Excel parsing with xlsx/exceljs, data validatio"
source: platform/sdlc/13_skills/active/SKILL_PIPELINE_001.yaml
canonical_id: SKILL_PIPELINE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_PIPELINE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_PIPELINE_001.playbook.md`
