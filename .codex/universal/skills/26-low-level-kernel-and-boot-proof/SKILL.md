---
name: 26-low-level-kernel-and-boot-proof
description: Low-Level Kernel and Boot Proof — SKILL_LOW_LEVEL_KERNEL_BOOT_001
source: platform/sdlc/13_skills/active/SKILL_LOW_LEVEL_KERNEL_BOOT_001.yaml
canonical_id: SKILL_LOW_LEVEL_KERNEL_BOOT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_LOW_LEVEL_KERNEL_BOOT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_LOW_LEVEL_KERNEL_BOOT_001.playbook.md`
