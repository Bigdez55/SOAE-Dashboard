...
description: "reliability security sentinel — ** Bridge to the GEN.OS reliability-security-sentinel custom agent persona. Use when the user explicitly asks to use, adopt, or spawn reliability-security-senti"
source: platform/sdlc/13_skills/active/SKILL_RELIABILITY_SECURITY_SENTINEL_001.yaml
canonical_id: SKILL_RELIABILITY_SECURITY_SENTINEL_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_RELIABILITY_SECURITY_SENTINEL_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_RELIABILITY_SECURITY_SENTINEL_001.playbook.md`
