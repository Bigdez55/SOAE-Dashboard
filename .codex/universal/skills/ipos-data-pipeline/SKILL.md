---
name: ipos-data-pipeline
description: "IPOS Data Pipeline — KPI data ingestion pipelines: Bronze/Silver/Gold medallion architecture, Trapeze CSV/Excel parsing, fuzzy column mapping, SUM-based MTD aggregation (never AVERA"
source: platform/sdlc/13_skills/active/SKILL_IPOS_DATA_PIPELINE_001.yaml
canonical_id: SKILL_IPOS_DATA_PIPELINE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_IPOS_DATA_PIPELINE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_IPOS_DATA_PIPELINE_001.playbook.md`
