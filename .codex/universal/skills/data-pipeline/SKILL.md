---
name: data-pipeline
description: "data-pipeline — ** KPI data ingestion pipelines: Bronze/Silver/Gold medallion architecture, Trapeze CSV/Excel parsing, fuzzy column mapping, SUM-based MTD aggregation (never AV"
source: platform/sdlc/13_skills/active/SKILL_DATA_PIPELINE_001.yaml
canonical_id: SKILL_DATA_PIPELINE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_DATA_PIPELINE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_DATA_PIPELINE_001.playbook.md`
