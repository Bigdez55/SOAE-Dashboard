...
description: "azure resource visualizer — ** Analyze Azure resource groups and generate detailed Mermaid architecture diagrams showing the relationships between individual resources. USE FOR: create arc"
source: platform/sdlc/13_skills/active/SKILL_AZURE_RESOURCE_VISUALIZER_001.yaml
canonical_id: SKILL_AZURE_RESOURCE_VISUALIZER_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_AZURE_RESOURCE_VISUALIZER_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_AZURE_RESOURCE_VISUALIZER_001.playbook.md`
