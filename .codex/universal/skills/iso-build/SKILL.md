---
name: iso-build
description: "GEN.OS ISO Build Pipeline — Build phases 0-9. Run on Ubuntu build host (Linux required for debootstrap). Reference: `GENOS_BUILD_EXECUTION_PLAN.md`, `build/` directory. sudo apt-get instal"
source: platform/sdlc/13_skills/active/SKILL_GENOS_ISO_BUILD_001.yaml
canonical_id: SKILL_GENOS_ISO_BUILD_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_GENOS_ISO_BUILD_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_GENOS_ISO_BUILD_001.playbook.md`
