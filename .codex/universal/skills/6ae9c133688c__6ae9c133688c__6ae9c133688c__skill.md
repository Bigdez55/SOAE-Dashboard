---
name: vault
description: Enterprise deployment patterns for SharePoint and Microsoft 365: SPFx tenant-wide deployment, M365 CLI commands, App Catalog management, SharePoint permissions and service principals, and GitHub Actions pipelines for automated SPFx deployment. Trigger on: "enterprise deployment", "SPFx deploy", "App Catalog", "M365 CLI", "tenant-wide", "sppkg", "SharePoint deployment".
---
