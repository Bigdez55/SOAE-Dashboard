...
description: "azure diagnostics — ** Debug and troubleshoot production issues on Azure. Covers Container Apps diagnostics, log analysis with KQL, health checks, and common issue resolution for i"
source: platform/sdlc/13_skills/active/SKILL_AZURE_DIAGNOSTICS_001.yaml
canonical_id: SKILL_AZURE_DIAGNOSTICS_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_AZURE_DIAGNOSTICS_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_AZURE_DIAGNOSTICS_001.playbook.md`
