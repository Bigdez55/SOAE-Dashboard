---
name: apex-verified-machine-encoding
description: apex-verified-machine-encoding — Prevent silent compiler/runtime defects from hand-computed machine-code constants in SUPER C / seedc / scc emit paths.
source: platform/sdlc/13_skills/active/SKILL_VERIFIED_MACHINE_ENCODING_001.yaml
canonical_id: SKILL_VERIFIED_MACHINE_ENCODING_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_VERIFIED_MACHINE_ENCODING_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_VERIFIED_MACHINE_ENCODING_001.playbook.md`
