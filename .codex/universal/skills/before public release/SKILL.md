...
description: "Public Release Auth, Rate, and Audit Gate — Use this skill before any multi-tenant platform is exposed publicly. This is a launch-blocker skill.  It verifies that production authentication, tenant/session"
source: platform/sdlc/13_skills/active/SKILL_PUBLIC_RELEASE_AUTH_RATE_AUDIT_GATE_001.yaml
canonical_id: SKILL_PUBLIC_RELEASE_AUTH_RATE_AUDIT_GATE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_PUBLIC_RELEASE_AUTH_RATE_AUDIT_GATE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_PUBLIC_RELEASE_AUTH_RATE_AUDIT_GATE_001.playbook.md`
