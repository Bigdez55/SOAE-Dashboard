...
description: "Mergeable Context Engine — Use this skill when context from multiple systems (Bookworm, Atlas, skill graphs, repo state) must be merged into a single prioritized payload for an agent or r"
source: platform/sdlc/13_skills/active/SKILL_MERGEABLE_CONTEXT_ENGINE_001.yaml
canonical_id: SKILL_MERGEABLE_CONTEXT_ENGINE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_MERGEABLE_CONTEXT_ENGINE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_MERGEABLE_CONTEXT_ENGINE_001.playbook.md`
