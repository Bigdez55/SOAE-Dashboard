---
name: graph intelligence workbench
description: "Atlas Graph Engine Visual Intelligence Workbench — Use this skill when building or reviewing the Atlas Graph Engine as a graph intelligence workbench. The output must be queryable, deterministic, provenance-back"
source: platform/sdlc/13_skills/active/SKILL_GRAPH_ENGINE_001.yaml
canonical_id: SKILL_GRAPH_ENGINE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_GRAPH_ENGINE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_GRAPH_ENGINE_001.playbook.md`
