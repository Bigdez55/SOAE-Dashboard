---
name: courier
description: "courier — ** Data export systems for dashboards: PDF generation using jsPDF and html2canvas, Excel export with SheetJS/xlsx, CSV download, ApexCharts dataURI chart snapsh"
source: platform/sdlc/13_skills/active/SKILL_COURIER_001.yaml
canonical_id: SKILL_COURIER_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_COURIER_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_COURIER_001.playbook.md`
