---
name: elson rollback
description: "Cloud Run Emergency Rollback — Roll back Cloud Run to the previous stable revision. Use when the user says rollback, revert production, undo deploy, or the health check is failing after a dep"
source: platform/sdlc/13_skills/active/SKILL_ELSON_ROLLBACK_001.yaml
canonical_id: SKILL_ELSON_ROLLBACK_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_ROLLBACK_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_ROLLBACK_001.playbook.md`
