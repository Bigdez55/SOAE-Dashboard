---
name: export-suite
description: "export-suite — ** Complete export capability: PDF generation (jsPDF + html2canvas), Excel workbooks (SheetJS with formatting), CSV download with BOM, PNG/SVG chart snapshots,"
source: platform/sdlc/13_skills/active/SKILL_EXPORT_SUITE_001.yaml
canonical_id: SKILL_EXPORT_SUITE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_EXPORT_SUITE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_EXPORT_SUITE_001.playbook.md`
