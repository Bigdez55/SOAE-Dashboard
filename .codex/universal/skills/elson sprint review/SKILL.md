---
name: elson sprint review
description: "Sprint Retrospective — Run a sprint retrospective — compare completed vs planned work, measure quality gate outcomes, identify blockers, and propose next sprint priorities. Use when t"
source: platform/sdlc/13_skills/active/SKILL_ELSON_SPRINT_REVIEW_001.yaml
canonical_id: SKILL_ELSON_SPRINT_REVIEW_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_SPRINT_REVIEW_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_SPRINT_REVIEW_001.playbook.md`
