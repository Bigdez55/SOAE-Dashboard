...
description: "azure messaging — ** Troubleshoot and resolve issues with Azure Messaging SDKs for Event Hubs and Service Bus. Covers connection failures, authentication errors, message processi"
source: platform/sdlc/13_skills/active/SKILL_AZURE_MESSAGING_001.yaml
canonical_id: SKILL_AZURE_MESSAGING_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_AZURE_MESSAGING_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_AZURE_MESSAGING_001.playbook.md`
