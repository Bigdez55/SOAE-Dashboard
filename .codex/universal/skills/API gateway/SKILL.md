---
name: API gateway
description: "API Gateway and Service Mesh — Use this skill to design tenant-aware API routing, rate limiting, service discovery, internal routing, gateway policy, and service-to-service communication."
source: platform/sdlc/13_skills/active/SKILL_API_GATEWAY_SERVICE_MESH_001.yaml
canonical_id: SKILL_API_GATEWAY_SERVICE_MESH_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_API_GATEWAY_SERVICE_MESH_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_API_GATEWAY_SERVICE_MESH_001.playbook.md`
