---
name: microsoft-foundry-models-deploy-model-capacity
description: "capacity — ** Discovers available Azure OpenAI model capacity across regions and projects. Analyzes quota limits, compares availability, and recommends optimal deployment"
source: platform/sdlc/13_skills/active/SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_CAPACITY_001.yaml
canonical_id: SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_CAPACITY_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_CAPACITY_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_CAPACITY_001.playbook.md`
