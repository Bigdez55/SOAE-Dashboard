---
name: theme-engine-539
description: "theme-engine — ** Design system generator: CSS custom properties token system (colors, spacing, typography, shadows), Tailwind CSS configuration, dark/light mode toggle, color"
source: platform/sdlc/13_skills/active/SKILL_THEME_ENGINE_001.yaml
canonical_id: SKILL_THEME_ENGINE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_THEME_ENGINE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_THEME_ENGINE_001.playbook.md`
