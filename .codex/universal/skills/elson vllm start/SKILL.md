---
name: elson vllm start
description: "Start vLLM VM — elson-dvora-training-l4-2 — Start the vLLM VM (elson-dvora-training-l4-2) for AI trading. Use when the user says start the model, start vLLM, power on the AI, or before market open on Mond"
source: platform/sdlc/13_skills/active/SKILL_ELSON_VLLM_START_001.yaml
canonical_id: SKILL_ELSON_VLLM_START_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_VLLM_START_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_VLLM_START_001.playbook.md`
