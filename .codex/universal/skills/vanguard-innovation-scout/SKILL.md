...
description: "vanguard innovation scout — ** Bridge to the GEN.OS vanguard-innovation-scout custom agent persona. Use when the user explicitly asks to use, adopt, or spawn vanguard-innovation-scout, or"
source: platform/sdlc/13_skills/active/SKILL_VANGUARD_INNOVATION_SCOUT_001.yaml
canonical_id: SKILL_VANGUARD_INNOVATION_SCOUT_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_VANGUARD_INNOVATION_SCOUT_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_VANGUARD_INNOVATION_SCOUT_001.playbook.md`
