...
description: "microsoft foundry — ** Use this skill to work with Microsoft Foundry (Azure AI Foundry) and tools from Foundry MCP server: deploy AI models, manage AI agents (create, deploy, invok"
source: platform/sdlc/13_skills/active/SKILL_MICROSOFT_FOUNDRY_001.yaml
canonical_id: SKILL_MICROSOFT_FOUNDRY_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_MICROSOFT_FOUNDRY_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_MICROSOFT_FOUNDRY_001.playbook.md`
