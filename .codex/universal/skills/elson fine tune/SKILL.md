---
name: elson fine tune
description: "Fine-Tuning Pipeline — elson-finance-14b (DoRA) — Assess fine-tuning readiness, prepare training data, and trigger the DoRA fine-tuning pipeline for elson-finance-14b. Use when the user asks about fine-tuning,"
source: platform/sdlc/13_skills/active/SKILL_ELSON_FINE_TUNE_001.yaml
canonical_id: SKILL_ELSON_FINE_TUNE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ELSON_FINE_TUNE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ELSON_FINE_TUNE_001.playbook.md`
