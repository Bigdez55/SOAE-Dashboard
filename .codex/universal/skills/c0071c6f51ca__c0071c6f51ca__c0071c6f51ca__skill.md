---
name: mosaic
description: Vue 3 / Nuxt 3 dashboard engineering with Codename MOSAIC. Covers Composition API with script setup, Pinia setup stores, VueUse composables, Vuetify 3 and Element Plus components, Vue-ECharts charting, Nuxt server routes, and SSR hydration patterns for KPI dashboards. Trigger on: "Vue dashboard", "Nuxt 3", "Vuetify data table", "Element Plus", "Pinia store", "Vue-ECharts", "Vue 3 composable", "MOSAIC".
---
