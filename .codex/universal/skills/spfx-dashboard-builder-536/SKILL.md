---
name: spfx-dashboard-builder-536
description: "spfx-dashboard-builder — ** Use this skill when the user wants to design, scaffold, or code a SharePoint Framework (SPFx) dashboard. Triggers on requests for \"SPFx web parts,\" \"SharePoi"
source: platform/sdlc/13_skills/active/SKILL_SPFX_DASHBOARD_BUILDER_001.yaml
canonical_id: SKILL_SPFX_DASHBOARD_BUILDER_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_SPFX_DASHBOARD_BUILDER_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_SPFX_DASHBOARD_BUILDER_001.playbook.md`
