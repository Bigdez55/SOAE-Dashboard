---
name: apex-parallel-deploy
description: "apex-parallel-deploy — ** Parallel multi-agent deployment strategy for large-scale compiler or systems projects. Use this skill whenever the user wants to maximize coding agent throug"
source: platform/sdlc/13_skills/active/SKILL_PARALLEL_DEPLOY_001.yaml
canonical_id: SKILL_PARALLEL_DEPLOY_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_PARALLEL_DEPLOY_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_PARALLEL_DEPLOY_001.playbook.md`
