...
description: "design systems forge — ** Bridge to the GEN.OS design-systems-forge custom agent persona. Use when the user explicitly asks to use, adopt, or spawn design-systems-forge, or when the t"
source: platform/sdlc/13_skills/active/SKILL_DESIGN_SYSTEMS_FORGE_001.yaml
canonical_id: SKILL_DESIGN_SYSTEMS_FORGE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_DESIGN_SYSTEMS_FORGE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_DESIGN_SYSTEMS_FORGE_001.playbook.md`
