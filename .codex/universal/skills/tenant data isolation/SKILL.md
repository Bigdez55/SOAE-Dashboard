...
description: "Data Isolation and Storage — Use this skill to design tenant-aware storage, database isolation, backup, restore, retention, encryption, and data lifecycle."
source: platform/sdlc/13_skills/active/SKILL_DATA_ISOLATION_STORAGE_001.yaml
canonical_id: SKILL_DATA_ISOLATION_STORAGE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_DATA_ISOLATION_STORAGE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_DATA_ISOLATION_STORAGE_001.playbook.md`
