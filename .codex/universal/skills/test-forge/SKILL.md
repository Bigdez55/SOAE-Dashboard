---
name: test-forge
description: "test forge — ** Bridge to the GEN.OS test-forge custom agent persona. Use when the user explicitly asks to use, adopt, or spawn test-forge, or when the task needs this repo-"
source: platform/sdlc/13_skills/active/SKILL_TEST_FORGE_001.yaml
canonical_id: SKILL_TEST_FORGE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_TEST_FORGE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_TEST_FORGE_001.playbook.md`
