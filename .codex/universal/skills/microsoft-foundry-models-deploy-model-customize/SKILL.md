---
name: microsoft-foundry-models-deploy-model-customize
description: "customize — ** Interactive guided deployment flow for Azure OpenAI models with full customization control. Step-by-step selection of model version, SKU (GlobalStandard/Stan"
source: platform/sdlc/13_skills/active/SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_CUSTOMIZE_001.yaml
canonical_id: SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_CUSTOMIZE_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_CUSTOMIZE_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_MICROSOFT_FOUNDRY_MODELS_DEPLOY_MODEL_CUSTOMIZE_001.playbook.md`
