---
name: admin console
description: Admin Console and Tenant Operations — Use this skill to design the platform operator console and tenant admin console for multi-tenant systems.
source: platform/sdlc/13_skills/active/SKILL_ADMIN_CONSOLE_TENANT_OPS_001.yaml
canonical_id: SKILL_ADMIN_CONSOLE_TENANT_OPS_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_ADMIN_CONSOLE_TENANT_OPS_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_ADMIN_CONSOLE_TENANT_OPS_001.playbook.md`
