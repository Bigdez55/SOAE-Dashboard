---
name: atlas shell
description: "ATLAS Workspace Shell and Command Palette — Port and maintain the ATLAS workspace shell as the uniform platform chrome for authenticated pages: destination sidebar, topbar wordmark, centered command palet"
source: platform/sdlc/13_skills/active/SKILL_WORKSPACE_SHELL_001.yaml
canonical_id: SKILL_WORKSPACE_SHELL_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_WORKSPACE_SHELL_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_WORKSPACE_SHELL_001.playbook.md`
