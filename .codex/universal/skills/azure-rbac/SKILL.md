---
name: azure-rbac
description: "azure rbac — ** Helps users find the right Azure RBAC role for an identity with least privilege access, then generate CLI commands and Bicep code to assign it. USE FOR: \"wha"
source: platform/sdlc/13_skills/active/SKILL_AZURE_RBAC_001.yaml
canonical_id: SKILL_AZURE_RBAC_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_AZURE_RBAC_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_AZURE_RBAC_001.playbook.md`
