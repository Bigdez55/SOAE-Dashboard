---
name: microsoft-foundry-foundry-agent-create-agent-framework
description: "agent framework — ** Create AI agents and workflows using Microsoft Agent Framework SDK. Supports single-agent and multi-agent workflow patterns. USE FOR: create agent, build age"
source: platform/sdlc/13_skills/active/SKILL_MICROSOFT_FOUNDRY_FOUNDRY_AGENT_CREATE_AGENT_FRAMEWORK_001.yaml
canonical_id: SKILL_MICROSOFT_FOUNDRY_FOUNDRY_AGENT_CREATE_AGENT_FRAMEWORK_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_MICROSOFT_FOUNDRY_FOUNDRY_AGENT_CREATE_AGENT_FRAMEWORK_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_MICROSOFT_FOUNDRY_FOUNDRY_AGENT_CREATE_AGENT_FRAMEWORK_001.playbook.md`
