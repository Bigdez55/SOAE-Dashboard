---
name: orchestration
description: "Runtime Orchestration — Use this skill to design deployment and orchestration for multi-tenant platforms across local, Docker Compose, GEN.OS sovereign orchestration, optional Kubernet"
source: platform/sdlc/13_skills/active/SKILL_RUNTIME_ORCHESTRATION_001.yaml
canonical_id: SKILL_RUNTIME_ORCHESTRATION_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_RUNTIME_ORCHESTRATION_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_RUNTIME_ORCHESTRATION_001.playbook.md`
