...
description: "edge ai optimizer — ** Bridge to the GEN.OS edge-ai-optimizer custom agent persona. Use when the user explicitly asks to use, adopt, or spawn edge-ai-optimizer, or when the task ne"
source: platform/sdlc/13_skills/active/SKILL_EDGE_AI_OPTIMIZER_001.yaml
canonical_id: SKILL_EDGE_AI_OPTIMIZER_001
generated: 2026-05-27
runtime: codex
---

> **Runtime projection of `SKILL_EDGE_AI_OPTIMIZER_001`.** Edit the canonical, not this file.
> Source of truth: `platform/sdlc/13_skills/active/SKILL_EDGE_AI_OPTIMIZER_001.playbook.md`
